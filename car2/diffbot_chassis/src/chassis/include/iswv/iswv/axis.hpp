...
public:
  ...
  Result<void> apply_safety_policy(
    SafetyPolicy policy,
    canopen::SdoOptions sdo = {});

  Result<void> configure_velocity_mode(
    bool immediate,
    double acceleration_rps2,
    double deceleration_rps2,
    canopen::SdoOptions sdo = {});
  Result<void> command_motor_velocity_rpm(
    double rpm,
    canopen::SdoOptions sdo = {});
  Result<void> command_travel_velocity_mps(
    double metres_per_second,
    canopen::SdoOptions sdo = {});
  Result<void> command_velocity_pdo(double motor_rpm);

  Result<void> configure_position_mode(
    double profile_velocity_rpm,
    double acceleration_rps2,
    double deceleration_rps2,
    canopen::SdoOptions sdo = {});
  Result<void> move_absolute_inc(
    std::int32_t target,
    canopen::SdoOptions sdo = {});
  Result<void> move_relative_inc(
    std::int32_t delta,
    canopen::SdoOptions sdo = {});
  Result<void> move_continuous_absolute_inc(
    std::int32_t target,
    canopen::SdoOptions sdo = {});
  Result<void> move_steering_angle_rad(
    double radians,
    canopen::SdoOptions sdo = {});
  ...
  Result<void> set_software_limits(
    std::int32_t negative,
    std::int32_t positive,
    canopen::SdoOptions sdo = {});
  Result<void> set_stop_options(
  ...
  Result<void> set_can_parameters(
