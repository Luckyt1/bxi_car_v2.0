...
public:
    ...
    explicit SteeringLayout(canopen::CanopenMaster& can0) : SteeringLayout(can0, {}) {}
    ...
    Result<void> configure(const SteeringLayoutConfig& configuration,
                            canopen::SdoOptions sdo = {})
    {
        for (const auto& axis : axes_) {
            ...
            result = axis->configure_position_mode(configuration.profile_velocity_rpm,
