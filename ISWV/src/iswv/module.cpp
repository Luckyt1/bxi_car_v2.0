...
std::shared_ptr<Module> Module::from_manual(canopen::CanopenMaster& master,
                                            ...
                                            std::uint8_t steering_node_id)
{
    ...
    auto travel = std::make_shared<Axis>(master.node(travel_node_id),
...
Result<void> Module::configure_default_pdos(DefaultPdoOptions options,
